...
Codex adapter는 MVP generator가 따를 preview output, mapping과 validation 계약을 `mvp-contract` 수준으로 정리했습니다. 이는 계약 문서의 확정이며 adapter 또는 generator 구현의 시작을 의미하지 않습니다.
