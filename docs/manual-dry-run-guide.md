...
| `python-cli-automation` | `examples/codex/python-cli-automation/` | `ready-with-warnings` | Bridge 없는 구성, architecture fragment pending, Git-auto skill routing |
...
### `fullstack-spring-react` + Codex

- Backend와 frontend 조합의 다중 bridge 및 authority 검토
- Server/client API contract와 skill routing 중복 검토
- Preview size budget과 section 압축 검토
