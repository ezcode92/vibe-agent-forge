...
현재 문서는 Java, Kotlin, Python, JavaScript와 Dart language fragment 초안의 책임만 정의한다. Framework/platform fragment, 실제 bridge, skill, profile YAML, registry catalog와 실행 구현은 아직 만들지 않는다.
